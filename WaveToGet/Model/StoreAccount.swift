...
//    @Published var country: String = ""
    ...
    @Published var GoogleReviewURL: String = ""
    ...
    @Published var ref: Referral = Referral()
}
...
struct Referral: Decodable {
    var id: Int = 0
    var senderamount: Float = 0
    var recieveramount: Float = 0
    var name: String = ""
    var message: String = ""
}
func AssignStoreReferral(withParameters id: Int, senderamount: String, recieveramount: String, name:String,message:String) -> Referral
{
    var temp:Referral = Referral()
    temp.id = id
    temp.senderamount = Float(senderamount) ?? 0
    temp.recieveramount = Float(recieveramount) ?? 0
    temp.name = name
    temp.message = message
    return temp
}

func AssignRedeemable(withParameters id: Int, name: String, description: String, image:String,points:Int) -> Redeemable
{
